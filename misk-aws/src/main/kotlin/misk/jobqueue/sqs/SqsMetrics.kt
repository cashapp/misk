...
internal class SqsMetrics @Inject internal constructor(metrics: Metrics) {
  ...
  val jobsReceived =
    metrics.counter("jobs_received_total", "total # of jobs received on a queueName", listOf("queueName", "QueueName"))
  ...
  val sqsApproxNumberOfMessagesNotVisible =
    metrics.gauge(
