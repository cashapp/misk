...
interface LogCollector : TestFixture {
  ...
  fun takeMessages(loggerClass: KClass<*>? = null, minLevel: Level = Level.INFO, pattern: Regex? = null): List<String>
  ...
  /**
   * Waits until a matching event is logged, and returns its message. The returned event and all preceding events are
   * also removed.
   */
  fun takeMessage(loggerClass: KClass<*>? = null, minLevel: Level = Level.INFO, pattern: Regex? = null): String
  ...
  /**
   * Waits until a matching event is logged, and returns it. The returned event and all preceding events are also
   * removed.
   */
