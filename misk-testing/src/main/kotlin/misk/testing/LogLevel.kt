...
/**
 * Annotate your test classes or methods with `@LogLevel` to change the log level used by the test. It can be useful to
 * have different LogLevel by test, specially if you're debugging issues on CI.
 *
