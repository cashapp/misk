...
data class DashboardTheme(val dashboard_slug: String, val theme: MiskWebTheme)

@Deprecated("DashboardTheme is no longer supported in the new v2 dashboard and will be removed")
inline fun <reified DA : Annotation> DashboardTheme(theme: MiskWebTheme) =
  DashboardTheme(dashboard_slug = ValidWebEntry.slugify<DA>(), theme = theme)
