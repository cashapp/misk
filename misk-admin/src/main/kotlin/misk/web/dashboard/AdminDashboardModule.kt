...
import misk.web.mcp.ContainerAdminMcpModule
 ...
 *
 * To add tabs to the Misk Admin Dashboard, bind the [DashboardTab] with the Dashboard Annotation [AdminDashboard]. Tabs
 * are then included in the admin dashboard menu grouping according to the [DashboardTab].category field and sorting by
 * [DashboardTab].name
 */
...
constructor(
  ...
  override fun configure() {
    ...
    // MCP endpoint for AI/LLM access to container metadata
    install(ContainerAdminMcpModule())
  }
}
...
@Qualifier @Target(AnnotationTarget.FIELD, AnnotationTarget.FUNCTION) annotation class AdminDashboard
