 ...
 *
 * @property configuration_endpoint The endpoint of a node in the cluster that can be used to discover the rest of the
 *   cluster.
 ...
 * @property topology_refresh_period_ms If set, the cluster topology will be refreshed periodically at this interval (in
 *   milliseconds). When null (default), topology is only refreshed reactively on errors/redirects.
 */
