...
class RedisClientMetrics @Inject constructor(private val ticker: Ticker, metrics: Metrics) {
  internal val maxTotalConnectionsGauge =
    metrics.gauge(
  ...
  internal val maxIdleConnectionsGauge =
    metrics.gauge(
