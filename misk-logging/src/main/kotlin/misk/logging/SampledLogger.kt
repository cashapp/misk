...
class SampledLogger constructor(override val underlyingLogger: KLogger, private val sampler: Sampler) : KLogger {

  private inline fun sampled(f: () -> Unit) {
    if (sampler.sample()) f()
  }

  override fun <T : Throwable> catching(throwable: T) = sampled { underlyingLogger.catching(throwable) }
  ...
  override fun debug(format: String?, vararg arguments: Any?) = sampled { underlyingLogger.debug(format, arguments) }

  override fun debug(msg: String?, t: Throwable?) = sampled { underlyingLogger.debug(msg, t) }

  override fun debug(marker: org.slf4j.Marker?, msg: String?) = sampled { underlyingLogger.debug(marker, msg) }

  override fun debug(marker: org.slf4j.Marker?, format: String?, arg: Any?) = sampled {
    underlyingLogger.debug(marker, format, arg)
  }

  override fun debug(marker: org.slf4j.Marker?, format: String?, arg1: Any?, arg2: Any?) = sampled {
    underlyingLogger.debug(marker, format, arg1, arg2)
  }

  override fun debug(marker: org.slf4j.Marker?, format: String?, vararg arguments: Any?) = sampled {
    underlyingLogger.debug(marker, format, arguments)
  }

  override fun debug(marker: org.slf4j.Marker?, msg: String?, t: Throwable?) = sampled {
    underlyingLogger.debug(marker, msg, t)
  }

  override fun entry(vararg argArray: Any?) = sampled { underlyingLogger.entry(argArray) }
  ...
  override fun error(marker: org.slf4j.Marker?, msg: String?) = sampled { underlyingLogger.error(marker, msg) }

  override fun error(marker: org.slf4j.Marker?, format: String?, arg: Any?) = sampled {
    underlyingLogger.error(marker, format, arg)
  }

  override fun error(marker: org.slf4j.Marker?, format: String?, arg1: Any?, arg2: Any?) = sampled {
    underlyingLogger.error(marker, format, arg1, arg2)
  }

  override fun error(marker: org.slf4j.Marker?, format: String?, vararg arguments: Any?) = sampled {
    underlyingLogger.error(marker, format, arguments)
  }

  override fun error(marker: org.slf4j.Marker?, msg: String?, t: Throwable?) = sampled {
  ...
  override fun info(marker: Marker?, t: Throwable?, msg: () -> Any?) = sampled { underlyingLogger.info(marker, t, msg) }
  ...
  override fun info(marker: org.slf4j.Marker?, msg: String?) = sampled { underlyingLogger.info(marker, msg) }

  override fun info(marker: org.slf4j.Marker?, format: String?, arg: Any?) = sampled {
    underlyingLogger.info(marker, format, arg)
  }

  override fun info(marker: org.slf4j.Marker?, format: String?, arg1: Any?, arg2: Any?) = sampled {
    underlyingLogger.info(marker, format, arg1, arg2)
  }

  override fun info(marker: org.slf4j.Marker?, format: String?, vararg arguments: Any?) = sampled {
    underlyingLogger.info(marker, format, arguments)
  }

  override fun info(marker: org.slf4j.Marker?, msg: String?, t: Throwable?) = sampled {
  ...
  override fun trace(marker: Marker?, msg: () -> Any?) = sampled { underlyingLogger.trace(marker, msg) }
  ...
  override fun trace(marker: org.slf4j.Marker?, msg: String?) = sampled { underlyingLogger.trace(marker, msg) }

  override fun trace(marker: org.slf4j.Marker?, format: String?, arg: Any?) = sampled {
    underlyingLogger.trace(marker, format, arg)
  }

  override fun trace(marker: org.slf4j.Marker?, format: String?, arg1: Any?, arg2: Any?) = sampled {
    underlyingLogger.trace(marker, format, arg1, arg2)
  }

  override fun trace(marker: org.slf4j.Marker?, format: String?, vararg argArray: Any?) = sampled {
    underlyingLogger.trace(marker, format, argArray)
  }

  override fun trace(marker: org.slf4j.Marker?, msg: String?, t: Throwable?) = sampled {
  ...
  override fun warn(marker: Marker?, t: Throwable?, msg: () -> Any?) = sampled { underlyingLogger.warn(marker, t, msg) }
  ...
  override fun warn(format: String?, vararg arguments: Any?) = sampled { underlyingLogger.warn(format, arguments) }

  override fun warn(format: String?, arg1: Any?, arg2: Any?) = sampled { underlyingLogger.warn(format, arg1, arg2) }

  override fun warn(msg: String?, t: Throwable?) = sampled { underlyingLogger.warn(msg, t) }

  override fun warn(marker: org.slf4j.Marker?, msg: String?) = sampled { underlyingLogger.warn(marker, msg) }

  override fun warn(marker: org.slf4j.Marker?, format: String?, arg: Any?) = sampled {
    underlyingLogger.warn(marker, format, arg)
  }

  override fun warn(marker: org.slf4j.Marker?, format: String?, arg1: Any?, arg2: Any?) = sampled {
    underlyingLogger.warn(marker, format, arg1, arg2)
  }

  override fun warn(marker: org.slf4j.Marker?, format: String?, vararg arguments: Any?) = sampled {
    underlyingLogger.warn(marker, format, arguments)
  }

  override fun warn(marker: org.slf4j.Marker?, msg: String?, t: Throwable?) = sampled {
