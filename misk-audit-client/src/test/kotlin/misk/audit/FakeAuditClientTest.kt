...
class FakeAuditClientTest {
  ...
  fun `fake with logging enabled`() {
    ...
    assertThat(logCollector.takeMessage(FakeAuditClient::class))
      .isEqualTo(
        "Audit Event Logged [event=FakeAuditEvent(eventSource=test-app, eventTarget=the-database-001, timestampSent=2147483647, applicationName=test-app, approverLDAP=null, automatedChange=false, description=description, richDescription=null, environment=testing, detailURL=null, region=us-west-2, requestorLDAP=default-user)]"
      )
  }
