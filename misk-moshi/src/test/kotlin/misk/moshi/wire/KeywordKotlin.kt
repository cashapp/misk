...
public class KeywordKotlin(
  @field:WireField(tag = 1, adapter = "com.squareup.wire.ProtoAdapter#STRING", declaredName = "object")
  @JvmField
  ...
  public class Builder : Message.Builder<KeywordKotlin, Builder>() {
    @JvmField public var object_: String? = null

    @JvmField public var when_: Int? = null

    @JvmField public var fun_: Map<String, String> = emptyMap()

    @JvmField public var return_: List<Boolean> = emptyList()

    @JvmField public var enums: List<KeywordKotlinEnum> = emptyList()
    ...
    public override fun build(): KeywordKotlin =
      KeywordKotlin(
        object_ = object_,
  ...
  public companion object {
    @JvmField
    public val ADAPTER: ProtoAdapter<KeywordKotlin> =
      object :
        ProtoAdapter<KeywordKotlin>(
        ...
        private val funAdapter: ProtoAdapter<Map<String, String>> by lazy { newMapAdapter(STRING, STRING) }
        ...
        public override fun redact(value: KeywordKotlin): KeywordKotlin = value.copy(unknownFields = ByteString.EMPTY)
      }

    private const val serialVersionUID: Long = 0L
  }

  public enum class KeywordKotlinEnum(public override val value: Int) : WireEnum {
    @WireEnumConstant(declaredName = "object") object_(0),
    @WireEnumConstant(declaredName = "when") when_(1),
    @WireEnumConstant(declaredName = "fun") fun_(2),
    @WireEnumConstant(declaredName = "return") return_(3),
    @WireEnumConstant(declaredName = "open") open_(4);

    public companion object {
      @JvmField
      public val ADAPTER: ProtoAdapter<KeywordKotlinEnum> =
        object : EnumAdapter<KeywordKotlinEnum>(KeywordKotlinEnum::class, Syntax.PROTO_2, object_) {
          public override fun fromValue(value: Int): KeywordKotlinEnum? = KeywordKotlinEnum.fromValue(value)
        }

      @JvmStatic
      public fun fromValue(value: Int): KeywordKotlinEnum? =
        when (value) {
          0 -> object_
          1 -> when_
          2 -> fun_
