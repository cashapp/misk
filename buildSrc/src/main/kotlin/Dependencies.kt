...
object Dependencies {
  ...
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.18"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.18"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.18"
  val wireMoshiAdapter = "com.squareup.wire:wire-moshi-adapter:4.0.0-alpha.18"
  val wireReflector = "com.squareup.wire:wire-reflector:4.0.0-alpha.18"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.0.0-alpha.18"
  val wireSchema = "com.squareup.wire:wire-schema:4.0.0-alpha.18"
