object Dependencies {
  ...
  val wispAwsEnvironment = "app.cash.wisp:wisp-aws-environment:1.0.7"
  val wispBom = "app.cash.wisp:wisp-bom:1.0.7"
  val wispClient = "app.cash.wisp:wisp-client:1.0.7"
  val wispConfig = "app.cash.wisp:wisp-config:1.0.7"
  val wispContainersTesting = "app.cash.wisp:wisp-containers-testing:1.0.7"
  val wispDeployment = "app.cash.wisp:wisp-deployment:1.0.7"
  val wispDeploymentTesting = "app.cash.wisp:wisp-deployment-testing:1.0.7"
  val wispFeature = "app.cash.wisp:wisp-feature:1.0.7"
  val wispFeatureTesting = "app.cash.wisp:wisp-feature-testing:1.0.7"
  val wispLaunchDarkly = "app.cash.wisp:wisp-launchdarkly:1.0.7"
  val wispLease = "app.cash.wisp:wisp-lease:1.0.7"
  val wispLeaseTesting = "app.cash.wisp:wisp-lease-testing:1.0.7"
  val wispLogging = "app.cash.wisp:wisp-logging:1.0.7"
  val wispLoggingTesting = "app.cash.wisp:wisp-logging-testing:1.0.7"
  val wispMoshi = "app.cash.wisp:wisp-moshi:1.0.7"
  val wispResourceLoader = "app.cash.wisp:wisp-resource-loader:1.0.7"
  val wispResourceLoaderTesting = "app.cash.wisp:wisp-resource-loader-testing:1.0.7"
  val wispSsl = "app.cash.wisp:wisp-ssl:1.0.7"
  val wispTokenTesting = "app.cash.wisp:wisp-token-testing:1.0.7"
  val wispTracing = "app.cash.wisp:wisp-tracing:1.0.7"
