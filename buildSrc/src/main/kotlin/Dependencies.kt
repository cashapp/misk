...
object Dependencies {
  ...
  val aws2Dynamodb = "software.amazon.awssdk:dynamodb:2.17.40"
  val aws2DynamodbEnhanced = "software.amazon.awssdk:dynamodb-enhanced:2.17.40"
  val aws2Regions = "software.amazon.awssdk:regions:2.17.40"
  ...
  val hopliteCore = "com.sksamuel.hoplite:hoplite-core:1.4.7"
  val hopliteHocon = "com.sksamuel.hoplite:hoplite-hocon:1.4.7"
  val hopliteJson = "com.sksamuel.hoplite:hoplite-json:1.4.7"
  val hopliteToml = "com.sksamuel.hoplite:hoplite-toml:1.4.7"
  val hopliteYaml = "com.sksamuel.hoplite:hoplite-yaml:1.4.7"
  ...
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.7"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.7"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.7"
  val wireMoshiAdapter = "com.squareup.wire:wire-moshi-adapter:4.0.0-alpha.7"
  val wireReflector = "com.squareup.wire:wire-reflector:4.0.0-alpha.7"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.0.0-alpha.7"
  val wireSchema = "com.squareup.wire:wire-schema:4.0.0-alpha.7"
