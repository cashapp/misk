object Dependencies {
  ...
  val dependencyAnalysisPluginVersion = "1.19.0"
  ...
  val grpcApi = "io.grpc:grpc-api:1.54.0"
  val grpcBom = "io.grpc:grpc-bom:1.54.0"
  val grpcGenJava = "io.grpc:protoc-gen-grpc-java:1.54.0"
  val grpcNetty = "io.grpc:grpc-netty:1.54.0"
  val grpcProtobuf = "io.grpc:grpc-protobuf:1.54.0"
  val grpcStub = "io.grpc:grpc-stub:1.54.0"
  ...
  val jettyAlpnServer = "org.eclipse.jetty:jetty-alpn-server:10.0.11"
  val jettyAlpnServerJava = "org.eclipse.jetty:jetty-alpn-java-server:10.0.11"
  val jettyBom = "org.eclipse.jetty:jetty-bom:10.0.11"
  val jettyHttp = "org.eclipse.jetty:jetty-http:10.0.11"
  val jettyHttp2 = "org.eclipse.jetty.http2:http2-server:10.0.11"
  val jettyHttp2Common = "org.eclipse.jetty.http2:http2-common:10.0.11"
  val jettyIo = "org.eclipse.jetty:jetty-io:10.0.11"
  ...
  val jettyUtil = "org.eclipse.jetty:jetty-util:10.0.11"
  ...
  val kotlinAllOpenPlugin = "org.jetbrains.kotlin:kotlin-allopen:1.8.20"
  val kotlinBinaryCompatibilityPlugin = "org.jetbrains.kotlinx:binary-compatibility-validator:0.13.1"
  val kotlinBom = "org.jetbrains.kotlin:kotlin-bom:1.8.20"
  ...
  val kotlinNoArgPlugin = "org.jetbrains.kotlin:kotlin-noarg:1.8.20"
  val kotlinReflect = "org.jetbrains.kotlin:kotlin-reflect:1.8.20"
  val kotlinRetry = "com.michael-bull.kotlin-retry:kotlin-retry:1.0.9"
  val kotlinStdLibJdk8 = "org.jetbrains.kotlin:kotlin-stdlib-jdk8:1.8.20"
  val kotlinTest = "org.jetbrains.kotlin:kotlin-test:1.8.20"
  ...
  val wireReflector = "com.squareup.wire:wire-reflector:4.6.0"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.6.0"
  val wireSchema = "com.squareup.wire:wire-schema:4.6.0"
  val wispAwsEnvironment = "app.cash.wisp:wisp-aws-environment"
  val wispBom = "app.cash.wisp:wisp-bom:1.3.12"
