object Dependencies {
  ...
  val tempest2Testing = "app.cash.tempest:tempest2-testing:1.10.2"
  val tempest2TestingDocker = "app.cash.tempest:tempest2-testing-docker:1.10.2"
  val tempest2TestingInternal = "app.cash.tempest:tempest2-testing-internal:1.10.2"
  val tempest2TestingJvm = "app.cash.tempest:tempest2-testing-jvm:1.10.2"
  val tempestTesting = "app.cash.tempest:tempest-testing:1.10.2"
  val tempestTestingDocker = "app.cash.tempest:tempest-testing-docker:1.10.2"
  val tempestTestingInternal = "app.cash.tempest:tempest-testing-internal:1.10.2"
  val tempestTestingJvm = "app.cash.tempest:tempest-testing-jvm:1.10.2"
