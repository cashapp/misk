object Dependencies {
  ...
  val wispAwsEnvironment = "app.cash.wisp:wisp-aws-environment:0.0.1-alpha"
  val wispBom = "app.cash.wisp:wisp-bom:0.0.1-alpha"
  val wispClient = "app.cash.wisp:wisp-client:0.0.1-alpha"
  val wispConfig = "app.cash.wisp:wisp-config:0.0.1-alpha"
  val wispContainersTesting = "app.cash.wisp:wisp-containers-testing:0.0.1-alpha"
  val wispDeployment = "app.cash.wisp:wisp-deployment:0.0.1-alpha"
  val wispDeploymentTesting = "app.cash.wisp:wisp-deployment-testing:0.0.1-alpha"
  val wispFeature = "app.cash.wisp:wisp-feature:0.0.1-alpha"
  val wispFeatureTesting = "app.cash.wisp:wisp-feature-testing:0.0.1-alpha"
  val wispLaunchDarkly = "app.cash.wisp:wisp-launchdarkly:0.0.1-alpha"
  val wispLease = "app.cash.wisp:wisp-lease:0.0.1-alpha"
  val wispLeaseTesting = "app.cash.wisp:wisp-lease-testing:0.0.1-alpha"
  val wispLogging = "app.cash.wisp:wisp-logging:0.0.1-alpha"
  val wispLoggingTesting = "app.cash.wisp:wisp-logging-testing:0.0.1-alpha"
  val wispMoshi = "app.cash.wisp:wisp-moshi:0.0.1-alpha"
  val wispResourceLoader = "app.cash.wisp:wisp-resource-loader:0.0.1-alpha"
  val wispResourceLoaderTesting = "app.cash.wisp:wisp-resource-loader-testing:0.0.1-alpha"
  val wispSsl = "app.cash.wisp:wisp-ssl:0.0.1-alpha"
  val wispTask = "app.cash.wisp:wisp-task:0.0.1-alpha"
  val wispTimeTesting = "app.cash.wisp:wisp-time-testing:0.0.1-alpha"
  val wispToken = "app.cash.wisp:wisp-token:0.0.1-alpha"
  val wispTokenTesting = "app.cash.wisp:wisp-token-testing:0.0.1-alpha"
  val wispTracing = "app.cash.wisp:wisp-tracing:0.0.1-alpha"
