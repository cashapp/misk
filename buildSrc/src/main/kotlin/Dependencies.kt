...
object Dependencies {
  ...
  val aws2Regions = "software.amazon.awssdk:regions:2.17.134"
  ...
  val hopliteCore = "com.sksamuel.hoplite:hoplite-core:2.0.3"
  val hopliteHocon = "com.sksamuel.hoplite:hoplite-hocon:2.0.3"
  val hopliteJson = "com.sksamuel.hoplite:hoplite-json:2.0.3"
  val hopliteToml = "com.sksamuel.hoplite:hoplite-toml:2.0.3"
  val hopliteYaml = "com.sksamuel.hoplite:hoplite-yaml:2.0.3"
  ...
  val jacksonBom = "com.fasterxml.jackson:jackson-bom:2.13.2"
  val jacksonDatabind = "com.fasterxml.jackson.core:jackson-databind:2.13.2"
  val jacksonDataformatYaml = "com.fasterxml.jackson.dataformat:jackson-dataformat-yaml:2.13.2"
  val jacksonJsr310 = "com.fasterxml.jackson.datatype:jackson-datatype-jsr310:2.13.2"
  val jacksonKotlin = "com.fasterxml.jackson.module:jackson-module-kotlin:2.13.2"
  ...
  val kotlinAllOpenPlugin = "org.jetbrains.kotlin:kotlin-allopen:1.6.10"
  val kotlinBinaryCompatibilityPlugin = "org.jetbrains.kotlinx:binary-compatibility-validator:0.6.0"
  val kotlinBom = "org.jetbrains.kotlin:kotlin-bom:1.6.10"
  val kotlinGradlePlugin = "org.jetbrains.kotlin:kotlin-gradle-plugin:1.6.10"
  val kotlinNoArgPlugin = "org.jetbrains.kotlin:kotlin-noarg:1.6.10"
  ...
  val okHttpMockWebServer = "com.squareup.okhttp3:mockwebserver:4.9.3"
