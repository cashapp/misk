...
object Dependencies {
  ...
  val awsDynamodb = "com.amazonaws:aws-java-sdk-dynamodb:1.11.892"
  val awsDynamodbLocal = "com.amazonaws:DynamoDBLocal:1.13.5"
  val awsS3 = "com.amazonaws:aws-java-sdk-s3:1.11.892"
  val awsSqs = "com.amazonaws:aws-java-sdk-sqs:1.11.892"
  ...
  val docker = "com.github.docker-java:docker-java:3.2.8"
  val gcpCloudStorage = "com.google.cloud:google-cloud-storage:1.113.1"
  ...
  val hopliteCore = "com.sksamuel.hoplite:hoplite-core:1.4.1"
  val hopliteHocon = "com.sksamuel.hoplite:hoplite-hocon:1.4.1"
  val hopliteJson = "com.sksamuel.hoplite:hoplite-json:1.4.1"
  val hopliteToml = "com.sksamuel.hoplite:hoplite-toml:1.4.1"
  val hopliteYaml = "com.sksamuel.hoplite:hoplite-yaml:1.4.1"
  ...
  val jnrUnixsocket = "com.github.jnr:jnr-unixsocket:0.38.3"
  ...
  val junitParams = "org.junit.jupiter:junit-jupiter-params:5.8.0-M1"
  val kotlinAllOpenPlugin = "org.jetbrains.kotlin:kotlin-allopen:1.4.10"
  val kotlinBom = "org.jetbrains.kotlin:kotlin-bom:1.4.10"
  val kotlinGradlePlugin = "org.jetbrains.kotlin:kotlin-gradle-plugin:1.4.10"
  val kotlinNoArgPlugin = "org.jetbrains.kotlin:kotlin-noarg:1.4.10"
  val kotlinReflection = "org.jetbrains.kotlin:kotlin-reflect:1.4.31"
  ...
  val kotlinTest = "org.jetbrains.kotlin:kotlin-test:1.4.21"
  ...
  val miskPolicyTesting = "com.squareup.misk:misk-policy-testing:2021.06.28-1624908971-80dbc03"
  val mockitoCore = "org.mockito:mockito-core:3.8.0"
  ...
  val tempest2TestingDocker = "app.cash.tempest:tempest2-testing-docker:2021.06.06-1623008639-5e69ec2"
  val tempest2TestingInternal = "app.cash.tempest:tempest2-testing-internal:2021.06.06-1623008639-5e69ec2"
  val tempest2TestingJvm = "app.cash.tempest:tempest2-testing-jvm:2021.06.06-1623008639-5e69ec2"
  val tempestTestingDocker = "app.cash.tempest:tempest-testing-docker:2021.06.06-1623008639-5e69ec2"
  val tempestTestingInternal = "app.cash.tempest:tempest-testing-internal:2021.06.06-1623008639-5e69ec2"
  val tempestTestingJvm = "app.cash.tempest:tempest-testing-jvm:2021.06.06-1623008639-5e69ec2"
...
||||||| constructed merge base
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.4"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.4"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.4"
  val wireMoshiAdapter = "com.squareup.wire:wire-moshi-adapter:4.0.0-alpha.4"
  val wireReflector = "com.squareup.wire:wire-reflector:4.0.0-alpha.4"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.0.0-alpha.4"
  val wireSchema = "com.squareup.wire:wire-schema:4.0.0-alpha.4"
=======
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.5"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.4"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.5"
