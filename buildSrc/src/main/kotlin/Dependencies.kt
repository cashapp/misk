...
object Dependencies {
  ...
  val hopliteCore = "com.sksamuel.hoplite:hoplite-core:1.4.9"
  val hopliteHocon = "com.sksamuel.hoplite:hoplite-hocon:1.4.9"
  val hopliteJson = "com.sksamuel.hoplite:hoplite-json:1.4.9"
  val hopliteToml = "com.sksamuel.hoplite:hoplite-toml:1.4.9"
  val hopliteYaml = "com.sksamuel.hoplite:hoplite-yaml:1.4.9"
  ...
  val openTracingDatadog = "com.datadoghq:dd-trace-ot:0.89.0"
  ...
  val tracingDatadog = "com.datadoghq:dd-trace-api:0.89.0"
  val vitess = "io.vitess:vitess-jdbc:10.0.0"
  val wireCompiler = "com.squareup.wire:wire-compiler:4.0.0-alpha.12"
  val wireGradlePlugin = "com.squareup.wire:wire-gradle-plugin:4.0.0-alpha.12"
  val wireGrpcClient = "com.squareup.wire:wire-grpc-client:4.0.0-alpha.12"
  val wireMoshiAdapter = "com.squareup.wire:wire-moshi-adapter:4.0.0-alpha.12"
  val wireReflector = "com.squareup.wire:wire-reflector:4.0.0-alpha.12"
  val wireRuntime = "com.squareup.wire:wire-runtime:4.0.0-alpha.12"
  val wireSchema = "com.squareup.wire:wire-schema:4.0.0-alpha.12"
