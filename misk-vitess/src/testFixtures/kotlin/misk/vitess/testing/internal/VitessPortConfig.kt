...
private constructor(
  ...
  companion object {
     ...
     *
     * The `userPort` arg represents the user desired location of where the vtagte lives. If the user port is set to
     * [DefaultSettings.DYNAMIC_PORT], a dynamic port will instead be assigned. All other Vitess ports are dynamic.
     * Dynamic port mode is generally preferred to avoid port conflicts.
     *
...
data class VitessPortMapping(val containerPort: Int, val hostPort: Int)
