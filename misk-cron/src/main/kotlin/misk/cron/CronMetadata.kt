...
internal data class CronMetadata(
  ...
  override fun descriptionBlock(tagConsumer: TagConsumer<*>): TagConsumer<*> = tagConsumer.apply {
    AlertInfoHighlight(
      message = "Cron job data is still untested in multi-pod deployments and may be inaccurate. This powers the Cron admin dashboard tab.",
      label = "Cron Tab",
      link = "/_admin/cron/",
    )
  }
...
internal class CronMetadataProvider : MetadataProvider<Metadata> {
  @Inject
  private lateinit var cronManager: CronManager
