...
/**
 * ChatWebSocketAction is a basic chat program which supports multiple chat rooms and their histories through web socket
 * connections.
 */
@Singleton
class ChatWebSocketAction @Inject constructor(private val redis: Redis) : WebAction {
