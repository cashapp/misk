        ...
        form {
          div("space-y-12") {
            div("border-b border-gray-900/10 pb-12") {
              ...
              p("mt-1 text-sm leading-6 text-gray-600") { +"""This information will be displayed publicly so be careful what you share.""" }
              div("mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6") {
                div("sm:col-span-4") {
                  ...
                  div("mt-2") {
                    div("flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md") {
                      ...
                      input(classes = "block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6") {
                        type = InputType.text
                        name = "username"
                        id = "username"
                ...
                div("col-span-full") {
                  ...
                  div("mt-2") {
                    textArea(classes = "block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6") {
                      id = "about"
                      name = "about"
                      rows = "3"
                    }
...
//                      }
            ...
            div("border-b border-gray-900/10 pb-12") {
              ...
              p("mt-1 text-sm leading-6 text-gray-600") { +"""We'll always let you know about important changes, but you pick what else you want to hear about.""" }
