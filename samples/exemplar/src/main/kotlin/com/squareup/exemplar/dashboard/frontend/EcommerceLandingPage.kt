...
//                        +"""<!-- Selected: "border-indigo-600 text-indigo-600", Not Selected: "border-transparent text-gray-900" -->"""
                        button(classes = "border-transparent text-gray-900 flex-1 whitespace-nowrap border-b-2 px-1 py-4 text-base font-medium") {
                          id = "tabs-1-tab-1"
...
//                    +"""<!-- Currency selector -->"""
                    form {
                      div("inline-block") {
                        ...
                        div("group relative -ml-2 rounded-md border-transparent focus-within:ring-2 focus-within:ring-white") {
                          select("flex items-center rounded-md border-transparent bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-gray-700 focus:border-transparent focus:outline-none focus:ring-0 group-hover:text-gray-800") {
                            id = "mobile-currency"
                            name = "currency"
                            option { +"""CAD""" }
                            option { +"""USD""" }
...
//              +"""<!-- Decorative image and overlay -->"""
              ...
              div("absolute inset-0 bg-gray-900 opacity-50") {
                attributes["aria-hidden"] = "true"
              }
//              +"""<!-- Navigation -->"""
...
//                      +"""<!-- Currency selector -->"""
                      form {
                        div {
                          ...
                          div("group relative -ml-2 rounded-md border-transparent bg-gray-900 focus-within:ring-2 focus-within:ring-white") {
                            select("flex items-center rounded-md border-transparent bg-gray-900 bg-none py-0.5 pl-2 pr-5 text-sm font-medium text-white focus:border-transparent focus:outline-none focus:ring-0 group-hover:text-gray-100") {
                              id = "desktop-currency"
                              name = "currency"
                              option { +"""CAD""" }
                              option { +"""USD""" }
              ...
              div("relative mx-auto flex max-w-3xl flex-col items-center px-6 py-32 text-center sm:py-64 lg:px-0") {
                ...
                p("mt-4 text-xl text-white") { +"""The new arrivals have, well, newly arrived. Check out the latest options from our summer small-batch release while they're still in stock.""" }
                a(classes = "mt-8 inline-block rounded-md border border-transparent bg-white px-8 py-3 text-base font-medium text-gray-900 hover:bg-gray-100") {
                  href = "#"
                  +"""Shop New Arrivals"""
                }
              }
                ...
                div("py-20 xl:grid xl:grid-cols-3 xl:gap-8") {
                  ...
                  div("mt-12 md:mt-16 xl:mt-0") {
                    ...
                    form(classes = "mt-2 flex sm:max-w-md") {
                      ...
                      input(classes = "w-full min-w-0 appearance-none rounded-md border border-white bg-white px-4 py-2 text-base text-gray-900 placeholder-gray-500 shadow-sm focus:border-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-900") {
                        id = "email-address"
                        type = InputType.text
                      ...
                      div("ml-4 flex-shrink-0") {
                        button(classes = "flex w-full items-center justify-center rounded-md border border-transparent bg-indigo-600 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 focus:ring-offset-gray-900") {
