...
class FakeFileLoaderTest {
  ...
  @MiskTestModule private val module = Modules.combine(TestingResourceLoaderModule(), FakeFilesModule())

  @Inject private lateinit var loader: ResourceLoader

  @Test
  fun loadFileFromMemory() {
  ...
  private class FakeFilesModule : KAbstractModule() {
    override fun configure() {
      newMapBinder<String, String>(ForFakeFiles::class).addBinding("/some/test/file").toInstance("test data!")
    }
  }
}
