...
/** These test keys are used by the [FakeKeyResolver] class. *DO NOT USE IN ANY OTHER SITUATION* */
internal class TestKeysets {
  companion object {
    ...
    /** Created with tikney: `tinkey create-keyset --key-template AES256_GCM` */
    val AEAD =
    ...
    /** Created with tikney: `tinkey create-keyset --key-template AES256_SIV` */
    val DAEAD =
      MiskConfig.RealSecret(
        """{
    ...
    /** Created with tikney: `tinkey create-keyset --key-template ECDSA_P256` */
    ...
    /** Created with tikney: `tinkey create-keyset --key-template ECIES_P256_HKDF_HMAC_SHA256_AES128_CTR_HMAC_SHA256` */
    val HYBRID =
      MiskConfig.RealSecret(
        """{
    ...
    /** Created with tikney: `tinkey create-keyset --key-template HMAC_SHA256_256BITTAG` */
    val MAC =
      MiskConfig.RealSecret(
        """{
    ...
    /** Created with tikney: `tinkey create-keyset --key-template AES256_GCM_HKDF_4KB` */
    val STREAMING_AEAD =
      MiskConfig.RealSecret(
        """{
