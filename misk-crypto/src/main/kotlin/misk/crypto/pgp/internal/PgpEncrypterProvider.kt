...
class PgpEncrypterProvider(private val alias: KeyAlias) : Provider<PgpEncrypter>, KeyReader() {
  ...
  override fun get(): PgpEncrypter {
    ...
    val pgpPub = PGPPublicKeyRingCollection(PGPUtil.getDecoderStream(keyIn), JcaKeyFingerprintCalculator())
    ...
    return RealPgpEncrypter(encryptionKey!!).also { pgpEncrypterManager[key.key_name] = it }
  }
}
