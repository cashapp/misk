...
internal class RealPgpEncrypter(private val encryptionKey: PGPPublicKey) : PgpEncrypter {
  override fun encrypt(plaintext: ByteArray, armored: Boolean): ByteArray {
    ...
    val keyEncryptionMethodGenerator = JcePublicKeyKeyEncryptionMethodGenerator(encryptionKey).setProvider("BC")
