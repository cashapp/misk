...
class AsyncSwitchTest {
  @Test
  fun alwaysOnSwitchIsEnabled() {
    val switch = AlwaysOnSwitch()
  ...
  fun conditionalProviderReturnsEnabledInstanceWhenEnabled() {
    val module = object : KAbstractModule() {
      override fun configure() {
        bind<AsyncSwitch>().toInstance(AlwaysOnSwitch())
  ...
  @Test
  fun conditionalTypedProviderDefaultsToAlwaysOnWhenNoSwitchBound() {
    val module = object : KAbstractModule() {
      override fun configure() {
        bind<Shape>().toInstance(Square())
        bind<Shape>().annotatedWith<TestAnnotation>().toInstance(Circle())
