 ...
 *
 * This is a convenience wrapper around [RedisClusterClient.create] that supports cluster-specific configuration
 * options. Unlike standalone Redis, a cluster client always requires a URI for topology discovery.
 *
 * Example:
 * ```kotlin
...
): RedisClusterClient = RedisClusterClient.create(clientResources, redisURI).apply { setOptions(clientOptions) }

/**
 * Executes a block with a Redis Cluster connection and automatically closes it afterward.
 *
 * This suspending function creates a cluster connection using [RedisClusterClient.connectAsync], executes the provided
 * block, and ensures the connection is closed properly using Kotlin's [use] function. It supports custom key and value
 * types through the codec.
 *
 * Example:
 * ```kotlin
 ...
 * delegates to [RedisClusterClient.connectAsync] with the UTF-8 String codec.
 *
 * Example:
 * ```kotlin
 ...
 *
 * This function uses [RedisClusterClient.connect] for synchronous connection creation. It supports custom key and value
 * types through the codec and handles proper connection cleanup using Kotlin's [use] function.
 *
 * Example:
 * ```kotlin
 ...
 * It delegates to [RedisClusterClient.connect] with the UTF-8 String codec.
 *
 * @param T The return type of the block
 * @param block The code to execute with the connection
 * @return The result of the block execution
 ...
 *
 * This function provides a Kotlin-friendly wrapper around [ClusterClientOptions.builder]. It allows configuration of
 * cluster-specific client options using a more idiomatic builder syntax.
 *
 * Example:
 * ```kotlin
 ...
 */
inline fun clusterClientOptions(builder: ClusterClientOptions.Builder.() -> Unit): ClusterClientOptions =
 ...
 *
 * This extension function provides a Kotlin-friendly way to configure socket options within a cluster client options
 * builder. It delegates to [ClusterClientOptions.Builder.socketOptions].
 *
 * @param builder Lambda with receiver for configuring the [SocketOptions.Builder]
...
): ClusterClientOptions.Builder = this@socketOptions.socketOptions(misk.redis.lettuce.cluster.socketOptions(builder))
 ...
 *
 * This extension function provides a Kotlin-friendly way to configure SSL options within a cluster client options
 * builder. It delegates to [ClusterClientOptions.Builder.sslOptions].
 *
 * @param builder Lambda with receiver for configuring the [SslOptions.Builder]
 * @return The [ClusterClientOptions.Builder] for method chaining
 */
...
): ClusterClientOptions.Builder = this@sslOptions.sslOptions(misk.redis.lettuce.cluster.sslOptions(builder))
 ...
 *
 * This extension function provides a Kotlin-friendly way to configure timeout options within a cluster client options
 * builder. It delegates to [ClusterClientOptions.Builder.timeoutOptions].
 *
 * @param builder Lambda with receiver for configuring the [TimeoutOptions.Builder]
 * @return The [ClusterClientOptions.Builder] for method chaining
 */
...
): ClusterClientOptions.Builder = this@timeoutOptions.timeoutOptions(misk.redis.lettuce.cluster.timeoutOptions(builder))

/**
 * Creates [ClusterTopologyRefreshOptions] using a builder pattern.
 *
 * This function provides a Kotlin-friendly wrapper around [ClusterTopologyRefreshOptions.builder]. It allows
 * configuration of cluster topology refresh behavior using a more idiomatic builder syntax.
 *
 * Example:
 * ```kotlin
...
): ClusterTopologyRefreshOptions = ClusterTopologyRefreshOptions.builder().apply(builder).build()

/**
 * Configures topology refresh options for a [ClusterClientOptions.Builder].
 *
 * This extension function provides a Kotlin-friendly way to configure topology refresh behavior within a cluster client
 * options builder. It delegates to [ClusterClientOptions.Builder.topologyRefreshOptions].
 *
 * Example:
 * ```kotlin
 * val options = clusterClientOptions {
...
inline fun ClusterClientOptions.Builder.clusterTopologyRefreshOptions(
  ...
  this@clusterTopologyRefreshOptions.topologyRefreshOptions(
    misk.redis.lettuce.cluster.clusterTopologyRefreshOptions(builder)
  )
