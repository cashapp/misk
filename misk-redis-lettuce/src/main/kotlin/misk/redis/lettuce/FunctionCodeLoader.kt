 ...
 * 1. Reading function code from the file specified in [RedisReplicationGroupConfig.functionCodeFilePath]
 *    and/or [RedisClusterGroupConfig.functionCodeFilePath]
 * 2. Loading the functions into Redis using the FUNCTION LOAD command
 * 3. Managing function registration and updates
 * 
 * Functions loaded through this interface are persistent across Redis restarts and are automatically
 * replicated to replica nodes, ensuring consistency across the Redis deployment.
 * 
 ...
 * @see <a href="https://redis.io/docs/latest/develop/interact/programmability/functions-intro/">Redis Functions Documentation</a>
