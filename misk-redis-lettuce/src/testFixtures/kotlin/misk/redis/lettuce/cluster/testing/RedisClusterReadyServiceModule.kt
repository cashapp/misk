 ...
 *
 * This module is designed to be used in testing scenarios where Redis clusters need to be verified as operational
 * before tests begin. It is particularly useful for:
 ...
 *
 * The service will block startup until all Redis clusters are ready and healthy, ensuring that tests don't begin until
