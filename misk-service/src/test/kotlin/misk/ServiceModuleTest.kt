...
class ServiceModuleTest {
  ...
  class TestService @Inject constructor(private val log: StringBuilder) : AbstractIdleService() {
    override fun startUp() {
      log.append("TestService.startUp\n")
    }

    override fun shutDown() {
      log.append("TestService.shutDown\n")
    }
  }
  ...
  class UpstreamService @Inject constructor(private val log: StringBuilder) : AbstractIdleService() {
    override fun startUp() {
      log.append("UpstreamService.startUp\n")
    }

    override fun shutDown() {
      log.append("UpstreamService.shutDown\n")
    }
  }
  ...
  class EnhancementService @Inject constructor(private val log: StringBuilder) : AbstractIdleService() {
    override fun startUp() {
      log.append("EnhancementService.startUp\n")
    }

    override fun shutDown() {
      log.append("EnhancementService.shutDown\n")
    }
  }
      ...
      Guice.createInjector(
        ...
        object : KAbstractModule() {
          override fun configure() {
            ...
            install(ServiceModule<TestService>().dependsOn<UpstreamService>().conditionalOn<TestSwitch>("test"))
          }
        },
      )
      ...
      Guice.createInjector(
        ...
        object : KAbstractModule() {
          override fun configure() {
            ...
            install(ServiceModule<TestService>().enhancedBy<EnhancementService>().conditionalOn<TestSwitch>("test"))
          }
        },
      )
      ...
      Guice.createInjector(
        ...
        object : KAbstractModule() {
          override fun configure() {
            ...
            install(ServiceModule<TestService>().conditionalOn<TestSwitch>("test"))
            install(ServiceModule<EnhancementService>().dependsOn<UpstreamService>().conditionalOn<TestSwitch>("test"))
          }
        },
      )
