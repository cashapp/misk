 ...
 * - SQLException with specific messages: Connection closed, Vitess transaction not found, CockroachDB restart
 *   transaction, TiDB write conflict
 *
 ...
 */
open class DefaultExceptionClassifier @JvmOverloads constructor(private val dataSourceType: DataSourceType? = null) :
  ExceptionClassifier {
  ...
  private fun isMessageRetryable(th: SQLException) = isConnectionClosed(th) || isDatabaseSpecificRetryable(th)
