...
/**
 * Standalone entry point for running schema migrations without Guice. Used by the schema-migrator Gradle plugin via
 * JavaExec.
 *
 * Reads configuration from stdin as a Properties file to avoid leaking sensitive values (like passwords) in process
 * argument lists.
 */
