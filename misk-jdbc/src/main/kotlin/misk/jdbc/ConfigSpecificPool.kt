...
/**
 * Figures out what database name to use for a given config. Tests use this to pool many databases for concurrent
 * execution. In development, staging, and production the database never changes.
 */
