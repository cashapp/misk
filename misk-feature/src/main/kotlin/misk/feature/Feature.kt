...
constructor(
  ...
  override fun with(name: String, value: String): Attributes = copy(text = text.plus(name to value))
  ...
  override fun copy(text: Map<String, String>, number: Map<String, Number>?, anonymous: Boolean): Attributes =
    Attributes(text, number, anonymous)
}
