package misk.cluster.messaging.grpc.client
...
class MiskGrpcClientModule : KAbstractModule() {
  ...
  @Provides
  @Singleton
  fun provideRouteGuide(grpcClient: GrpcClient): ClusterMessagingClient =
      grpcClient.create(ClusterMessagingClient::class)
}
