...
@Serializable
data class ThrowingToolInput(@Description("dummy parameter, can't have empty parameter list") val dummy: String)
...
suspend fun Client.callThrowingTool() = callTool(name = "throwing", arguments = mapOf("dummy" to "dummy"))
