...
@Serializable data class SessionIdentifierInput(val dummy: String = "unused")

@Serializable
data class SessionIdentifierOutput(@Description("The current MCP session identifier") val sessionId: String)

@OptIn(ExperimentalMiskApi::class)
class SessionIdentifierTool @Inject constructor(private val sessionId: McpSessionId) :
