...
@Singleton
class PrometheusHttpService
@Inject
internal constructor(private val config: PrometheusConfig, private val registry: CollectorRegistry) :
  AbstractIdleService() {
  ...
  override fun startUp() {
    ...
    val socketAddr =
      if (config.hostname == null) InetSocketAddress(config.http_port)
