...
interface Session : misk.jdbc.Session {
  ...
  /**
   * Disable one or more checks for the duration of the execution of [body]. The passed in checks will entirely replace
   * the other ignored checks at this point, they will not be merged with whatever is there currently.
   *
