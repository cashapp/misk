...
class HibernateDatabaseQueryMetadataFactoryTest {
  ...
  fun `static happy path`() {
    ...
    assertThat(metadata.constraints)
      .containsExactly(
        DatabaseQueryMetadata.ConstraintMetadata(
          name = "name",
          parametersTypeName = "Constraint/MovieQuery/name",
          path = "name",
          operator = "EQ",
        ),
        DatabaseQueryMetadata.ConstraintMetadata(
          name = "releaseDateIsNull",
          parametersTypeName = "Constraint/MovieQuery/releaseDateIsNull",
          path = "release_date",
          operator = "IS_NULL",
        ),
        DatabaseQueryMetadata.ConstraintMetadata(
          name = "releaseDateLessThan",
          parametersTypeName = "Constraint/MovieQuery/releaseDateLessThan",
          path = "release_date",
          operator = "LT",
        ),
      )
    assertThat(metadata.orders)
      .containsExactly(
        DatabaseQueryMetadata.OrderMetadata(
          name = "releaseDateAsc",
          parametersTypeName = "Order/MovieQuery/releaseDateAsc",
          path = "release_date",
          ascending = true,
        ),
        DatabaseQueryMetadata.OrderMetadata(
          name = "releaseDateDesc",
          parametersTypeName = "Order/MovieQuery/releaseDateDesc",
          path = "release_date",
          ascending = false,
        ),
      )
    assertThat(metadata.selects)
      .containsExactly(
        DatabaseQueryMetadata.SelectMetadata(
          name = "listAsNameAndReleaseDate",
          parametersTypeName = "Select/MovieQuery/listAsNameAndReleaseDate",
          paths = listOf(),
        ),
        DatabaseQueryMetadata.SelectMetadata(
          name = "listAsNames",
          parametersTypeName = "Select/MovieQuery/listAsNames",
          paths = listOf("name"),
        ),
        DatabaseQueryMetadata.SelectMetadata(
          name = "uniqueName",
          parametersTypeName = "Select/MovieQuery/uniqueName",
          paths = listOf("name"),
        ),
      )
    assertThat(metadata.types)
      .containsExactlyEntriesOf(
        mapOf(
          "Config/Query" to Type(fields = listOf(Field(name = "maxRows", repeated = false, type = "Int"))),
          "Constraint/MovieQuery/name" to
            Type(fields = listOf(Field(name = "name", type = "String", repeated = false))),
          "Constraint/MovieQuery/releaseDateIsNull" to
            Type(fields = listOf(Field(name = "Add Constraint", type = "Boolean", repeated = false))),
          "Constraint/MovieQuery/releaseDateLessThan" to
            Type(fields = listOf(Field(name = "upperBound", type = "LocalDate", repeated = false))),
          "Order/MovieQuery/releaseDateAsc" to
            Type(
              fields =
                listOf(Field(name = "Add Order (path=release_date, asc=true)", type = "Boolean", repeated = false))
            ),
          "Order/MovieQuery/releaseDateDesc" to
            Type(
              fields =
                listOf(Field(name = "Add Order (path=release_date, asc=false)", type = "Boolean", repeated = false))
            ),
          "Select/MovieQuery/listAsNameAndReleaseDate" to
            Type(fields = listOf(Field(name = "Add Select (paths=[])", type = "Boolean", repeated = false))),
          "Select/MovieQuery/listAsNames" to
            Type(fields = listOf(Field(name = "Add Select (paths=[name])", type = "Boolean", repeated = false))),
          "Select/MovieQuery/uniqueName" to
            Type(fields = listOf(Field(name = "Add Select (paths=[name])", type = "Boolean", repeated = false))),
          "queryType" to
            Type(
              fields =
                listOf(
                  ...
                  Field(
                    name = "Order/MovieQuery/releaseDateAsc",
                    type = "Order/MovieQuery/releaseDateAsc",
                    repeated = false,
                  ),
                  Field(
                    name = "Order/MovieQuery/releaseDateDesc",
                    type = "Order/MovieQuery/releaseDateDesc",
                    repeated = false,
                  ),
                  Field(
                    name = "Select/MovieQuery/listAsNameAndReleaseDate",
                    type = "Select/MovieQuery/listAsNameAndReleaseDate",
                    repeated = false,
                  ),
                  Field(
                    name = "Select/MovieQuery/listAsNames",
                    type = "Select/MovieQuery/listAsNames",
                    repeated = false,
                  ),
              ...
              fields =
                listOf(
                  ...
                  Field(
                    name = "operator",
                    type =
                      "Enum<misk.hibernate.Operator,LT,LE,EQ,EQ_OR_IS_NULL,GE,GT,NE,IN,NOT_IN,IS_NOT_NULL," +
                        "IS_NULL,LIKE>",
                    repeated = false,
                  ),
  ...
  interface MovieQuery : Query<DbMovie> {
    @Constraint(path = "name") fun name(name: String): MovieQuery

    @Constraint(path = "release_date", operator = Operator.LT)
    fun releaseDateLessThan(upperBound: LocalDate?): MovieQuery

    @Constraint(path = "release_date", operator = Operator.IS_NULL) fun releaseDateIsNull(): MovieQuery

    @Order(path = "release_date") fun releaseDateAsc(): MovieQuery

    @Order(path = "release_date", asc = false) fun releaseDateDesc(): MovieQuery
