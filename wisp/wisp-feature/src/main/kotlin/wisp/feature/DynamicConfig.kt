...
/**
 * Interface for evaluating dynamic flags. Dynamic flags are similar to feature flags, but they don't support different
 * variations for different keys.
 */
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "DynamicConfig()", imports = ["misk.feature.DynamicConfig"]),
)
...
inline fun <reified T : Enum<T>> DynamicConfig.getEnum(feature: Feature): T = getEnum(feature, T::class.java)
