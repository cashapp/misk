...
@Deprecated(
  ...
  replaceWith = ReplaceWith(expression = "FeatureFlags()", imports = ["misk.feature.FeatureFlags"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "Feature(name)", imports = ["misk.feature.Feature"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "Attributes(text, number, anonymous)", imports = ["misk.feature.Attributes"]),
)
...
constructor(
  ...
  open fun with(name: String, value: String): Attributes = copy(text = text.plus(name to value))
