...
constructor(
  ...
  /**
   * Returns true if running in a managed cluster, such as a staging or production cluster. Mutually exclusive with
   * isFake.
   */
  val isReal: Boolean
    get() = !isFake
...
val PRODUCTION =
  Deployment("production", isProduction = true, isStaging = false, isTest = false, isLocalDevelopment = false)

val STAGING = Deployment("staging", isProduction = false, isStaging = true, isTest = false, isLocalDevelopment = false)

val TESTING = Deployment("testing", isProduction = false, isStaging = false, isTest = true, isLocalDevelopment = false)

val DEVELOPMENT =
  Deployment("development", isProduction = false, isStaging = false, isTest = false, isLocalDevelopment = true)
...
/**
 * Determines a Deployment based on the value within the ENVIRONMENT variable, defaulting to local development if not
 * set (i.e. isLocalDevelopment == true)
 */
