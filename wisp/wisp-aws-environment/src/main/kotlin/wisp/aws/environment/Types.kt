...
@Deprecated(
  ...
  replaceWith = ReplaceWith(expression = "AwsRegion()", imports = ["misk.cloud.aws.AwsRegion"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "AwsAccountId()", imports = ["misk.cloud.aws.AwsAccountId"]),
)
