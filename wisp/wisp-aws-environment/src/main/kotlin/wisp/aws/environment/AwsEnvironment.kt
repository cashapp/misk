...
object AwsEnvironment {
  ...
  fun awsRegion(
    ...
    for (environmentVariable in environmentVariables) {
      val region = environmentVariableLoader.getEnvironmentVariableOrDefault(environmentVariable, "")
  ...
  ): AwsAccountId = AwsAccountId(environmentVariableLoader.getEnvironmentVariable(environmentVariable))
}
