...
open class SampledLogger constructor(override val underlyingLogger: KLogger, private val sampler: Sampler) :
  ...
  override fun debug(marker: Marker?, msg: String?) = sampled { underlyingLogger.debug(marker, msg) }
  ...
  override fun debug(marker: Marker?, msg: String?, t: Throwable?) = sampled { underlyingLogger.debug(marker, msg, t) }
  ...
  override fun error(marker: Marker?, msg: String?, t: Throwable?) = sampled { underlyingLogger.error(marker, msg, t) }
  ...
  override fun trace(marker: Marker?, msg: String?, t: Throwable?) = sampled { underlyingLogger.trace(marker, msg, t) }
