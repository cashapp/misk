...
@Deprecated(
  ...
  replaceWith = ReplaceWith(expression = "Tag()", imports = ["misk.logging.Tag"]),
)
typealias Tag = Pair<String, Any?>

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "getLogger()", imports = ["misk.logging.getLogger"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "sampled(sampler)", imports = ["misk.logging.sampled"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "info(*tags, message = message)", imports = ["misk.logging.info"]),
)
fun KLogger.info(vararg tags: Tag, message: () -> Any?) = log(Level.INFO, message = message, tags = tags)

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "warn(*tags, message = message)", imports = ["misk.logging.warn"]),
)
fun KLogger.warn(vararg tags: Tag, message: () -> Any?) = log(Level.WARN, message = message, tags = tags)

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "error(*tags, message = message)", imports = ["misk.logging.error"]),
)
fun KLogger.error(vararg tags: Tag, message: () -> Any?) = log(Level.ERROR, message = message, tags = tags)

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "debug(*tags, message = message)", imports = ["misk.logging.debug"]),
)
fun KLogger.debug(vararg tags: Tag, message: () -> Any?) = log(Level.DEBUG, message = message, tags = tags)

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "trace(*tags, message = message)", imports = ["misk.logging.trace"]),
)
fun KLogger.trace(vararg tags: Tag, message: () -> Any?) = log(Level.TRACE, message = message, tags = tags)

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "info(th, *tags, message = message)", imports = ["misk.logging.info"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "warn(th, *tags, message = message)", imports = ["misk.logging.warn"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "error(th, *tags, message = message)", imports = ["misk.logging.error"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "debug(th, *tags, message = message)", imports = ["misk.logging.debug"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "trace(th, *tags, message = message)", imports = ["misk.logging.trace"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "log(level, *tags, message = message)", imports = ["misk.logging.log"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "log(level, th, *tags, message = message)", imports = ["misk.logging.log"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "withTags(*tags, block = block)", imports = ["misk.logging.withTags"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith =
    ReplaceWith(expression = "withSmartTags(*tags, block = block)", imports = ["misk.logging.withSmartTags"]),
)
