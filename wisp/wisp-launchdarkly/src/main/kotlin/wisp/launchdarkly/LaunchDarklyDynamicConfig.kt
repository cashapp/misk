...
class LaunchDarklyDynamicConfig(private val featureFlags: FeatureFlags) : DynamicConfig {
  ...
  override fun getBoolean(feature: Feature) = featureFlags.getBoolean(feature, KEY, ATTRIBUTES)

  override fun getDouble(feature: Feature): Double = featureFlags.getDouble(feature, KEY, ATTRIBUTES)

  override fun getInt(feature: Feature) = featureFlags.getInt(feature, KEY, ATTRIBUTES)

  override fun getString(feature: Feature) = featureFlags.getString(feature, KEY, ATTRIBUTES)

  override fun <T : Enum<T>> getEnum(feature: Feature, clazz: Class<T>) =
    featureFlags.getEnum(feature, KEY, clazz, ATTRIBUTES)

  override fun <T> getJson(feature: Feature, clazz: Class<T>) = featureFlags.getJson(feature, KEY, clazz, ATTRIBUTES)
  ...
  override fun trackDouble(feature: Feature, executor: Executor, tracker: (Double) -> Unit): TrackerReference =
