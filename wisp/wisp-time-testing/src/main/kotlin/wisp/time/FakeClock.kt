...
@Deprecated(
  ...
  replaceWith = ReplaceWith(expression = "FakeClock()", imports = ["misk.time.FakeClock"]),
)
open class FakeClock
@JvmOverloads
constructor(epochMillis: Long = initialValue.toEpochMilli(), private val zone: ZoneId = ZoneId.of("UTC")) :
  Clock(), TestFixture {
