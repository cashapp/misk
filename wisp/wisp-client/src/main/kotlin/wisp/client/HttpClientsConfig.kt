...
@Deprecated(
  ...
  replaceWith = ReplaceWith(expression = "HttpClientsConfig", imports = ["misk.client.HttpClientsConfig"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "HttpClientSSLConfig", imports = ["misk.client.HttpClientSSLConfig"]),
)
data class HttpClientSSLConfig(val cert_store: CertStoreConfig?, val trust_store: TrustStoreConfig)

@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "HttpClientConfig", imports = ["misk.client.HttpClientConfig"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "HttpClientEndpointConfig", imports = ["misk.client.HttpClientEndpointConfig"]),
)
...
@Deprecated(
  message = "Duplicate implementations in Wisp are being migrated to the unified type in Misk.",
  replaceWith = ReplaceWith(expression = "HttpClientEnvoyConfig", imports = ["misk.client.HttpClientEnvoyConfig"]),
)
