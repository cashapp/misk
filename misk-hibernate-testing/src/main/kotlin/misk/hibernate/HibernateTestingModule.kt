 ...
 * [HibernateModule].
 *
 * If you run your tests in parallel, you need to install the [HibernateModule] as follows to ensure that your test
 * suites do not share databases concurrently:
 *
