...
dependencies {
  ...
  testFixturesApi(project(":misk:misk-gcp"))
  ...
  testFixturesImplementation(project(":misk:misk-testing"))
  ...
  testImplementation(project(":misk:misk-gcp"))
  testImplementation(project(":misk:misk-testing"))
  testImplementation(testFixtures(project(":misk:misk-gcp")))
}
