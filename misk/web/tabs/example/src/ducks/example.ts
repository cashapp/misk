...
export const dispatchExample = {
  delete: (id: number) => createAction(EXAMPLE.DELETE, { id, loading: true, success: false, error: null }),
  failure: (error: any) => createAction(EXAMPLE.FAILURE, { ...error, loading: false, success: false }),
  patch: (id: number, data: any) => createAction(EXAMPLE.PATCH, { id, ...data, loading: true, success: false, error: null }),
  put: (id: number, data: any) => createAction(EXAMPLE.PUT, { id, ...data, loading: true, success: false, error: null }),
  request: () => createAction(EXAMPLE.GET, { loading: true, success: false, error: null }),
  requestOne: (id: number) => createAction(EXAMPLE.GET_ONE, { id, loading: true, success: false, error: null }),
  save: (data: any) => createAction(EXAMPLE.SAVE, { ...data, loading: true, success: false, error: null }),
  success: (data: any) => createAction(EXAMPLE.SUCCESS, { ...data, loading: false, success: true, error: null }),
}
