...
import { RequestFormContainer } from "."
import {
  getFormData,
  IDispatchProps,
  IState,
 ...
 */
const SendQueryCollapseContainer = (
  props: { databaseQuery: IWebActionInternal; tag: string } & IState &
    IDispatchProps
) => {
  const { databaseQuery: action, tag } = props
