...
interface Session {
  ...
  fun <R : DbRoot<R>, T : DbSharded<R, T>> loadByGid(gid: Gid<R, T>, type: KClass<T>): T
...
inline fun <R : DbRoot<R>, reified S : DbSharded<R, S>> Session.loadByGid(gid: Gid<R, S>): S = loadByGid(gid, S::class)
