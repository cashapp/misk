...
class ProtoMessageHttpClient constructor(baseUrl: String, private val moshi: Moshi, private val okHttp: OkHttpClient) {
  private val httpUrl = baseUrl.toHttpUrlOrNull() ?: throw IllegalArgumentException("could not parse $baseUrl")
  ...
  inline fun <reified O : Any> post(path: String, requestBody: Message<*, *>) = post(path, requestBody, O::class.java)
}
