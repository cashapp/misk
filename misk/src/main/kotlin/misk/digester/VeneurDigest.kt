...
class VeneurDigestHistogram //this class is equivelent to veneur digest in the go service
  constructor (
    name: String,
    help: String,
    labelNames: List<String>,
    buckets: DoubleArray?
  ): Histogram, VeneurDigest {
  ...
  fun mergeInto(other: VeneurDigestHistogram) {
