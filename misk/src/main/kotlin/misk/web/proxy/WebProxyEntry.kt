 ...
 * ```
 */
data class WebProxyEntry @JvmOverloads constructor(val url_path_prefix: String = "/", val web_proxy_url: HttpUrl) :
  ValidWebEntry(valid_url_path_prefix = url_path_prefix) {
  init {
    require(web_proxy_url.encodedPath.endsWith("/") && web_proxy_url.pathSegments.size == 1)
  }
}
