...
@Inject
internal constructor(@JvmSuppressWildcards private val marshallerFactories: List<Marshaller.Factory>) {
  ...
  fun create(responseMediaType: MediaType, type: KType): Marshaller<Any> {
    return marshallerFactories.firstNotNullOfOrNull { it.create(responseMediaType, type) }
