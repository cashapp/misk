...
constructor(
  ...
  fun staticResource(url: HttpUrl): ValidWebEntry? = findEntryFromUrlString(staticResourceEntries, url.encodedPath)

  /** @return entry whose url_path_prefix most closely matches given url; longest match wins */
  fun webProxy(url: HttpUrl): ValidWebEntry? = findEntryFromUrlString(webProxyEntries, url.encodedPath)
