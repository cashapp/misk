...
@Singleton
internal class GracefulShutdownInterceptorFactory
@Inject
constructor(private val webConfig: WebConfig, private val gracefulShutdownService: GracefulShutdownService) :
