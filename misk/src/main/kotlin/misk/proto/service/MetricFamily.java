...
public final class MetricFamily extends Message<MetricFamily, MetricFamily.Builder> {
  ...
  @WireField(
      tag = 1,
      adapter = "misk.proto.service.MetricFamily$MetricDescriptor#ADAPTER"
  )
  ...
  @WireField(
      tag = 2,
      adapter = "misk.proto.service.MetricFamily$Metric#ADAPTER",
  ...
  public static final class Digest extends Message<Digest, Digest.Builder> {
    ...
    @WireField(
        tag = 4,
        adapter = "misk.proto.service.DigestData#ADAPTER"
    )
  ...
  public static final class Metric extends Message<Metric, Metric.Builder> {
    ...
    @WireField(
        tag = 2,
        adapter = "misk.proto.service.MetricFamily$Digest#ADAPTER",
        label = WireField.Label.REPEATED
    )
