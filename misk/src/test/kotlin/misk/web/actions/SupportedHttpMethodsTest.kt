...
class SupportedHttpMethodsTest {
  ...
  fun get() {
    val request =
      Request.Builder().get().url(jettyService.httpServerUrl.newBuilder().encodedPath("/resources/id").build()).build()
