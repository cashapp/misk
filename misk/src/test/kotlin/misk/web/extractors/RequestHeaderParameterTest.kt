...
internal class RequestHeaderParameterTest {
  ...
  fun happyPath() {
    ...
    assertThat(get("/echo-user-agent", headersOf())).isEqualTo("Required request header Cash-User-Agent not present")
  }

  @Test
  fun duplicateHeaderShouldError() {
    assertThat(get("/echo-user-agent", headersOf("cash-user-agent", "Cash App 4.0", "cash-user-agent", "Cash App 5.0")))
  ...
  fun optionalParameter() {
    assertThat(get("/echo-optional-user-agent", headersOf("cash-user-agent", "Cash App 4.0")))
      .isEqualTo("your user agent is 'Cash App 4.0'")
    assertThat(get("/echo-optional-user-agent", headersOf())).isEqualTo("your user agent is '<absent>'")
  }
  ...
  fun nullableParameter() {
    assertThat(get("/echo-nullable-user-agent", headersOf("cash-user-agent", "Cash App 4.0")))
      .isEqualTo("your user agent is 'Cash App 4.0'")
    assertThat(get("/echo-nullable-user-agent", headersOf())).isEqualTo("your user agent is 'null'")
  }
  ...
  fun nullableOptionalParameter() {
    assertThat(get("/echo-nullable-optional-user-agent", headersOf("cash-user-agent", "Cash App 4.0")))
      .isEqualTo("your user agent is 'Cash App 4.0'")
    assertThat(get("/echo-nullable-optional-user-agent", headersOf())).isEqualTo("your user agent is '<absent>'")
  }
  ...
  @Test
  fun multipleRequestHeaders() {
    assertThat(get("/multiple-request-headers", headersOf("user-agent", "Cash App 4.0", "accept-encoding", "gzip")))
  ...
  class EchoUserAgentAction @Inject constructor() : WebAction {
    @Get("/echo-user-agent")
    fun call(@RequestHeader("Cash-User-Agent") userAgent: String) = "your user agent is '$userAgent'"
  }

  class EchoOptionalUserAgentAction @Inject constructor() : WebAction {
    @Get("/echo-optional-user-agent")
    fun call(@RequestHeader("Cash-User-Agent") userAgent: String = "<absent>") = "your user agent is '$userAgent'"
  }
  ...
  class EchoUserAgentTypeAction @Inject constructor() : WebAction {
    ...
    fun call(@RequestHeader("Cash-User-Agent-Type") userAgentType: CashUserAgentType) =
  ...
  class MultipleRequestHeadersAction @Inject constructor() : WebAction {
    ...
    fun call(@RequestHeader("User-Agent") userAgent: String, @RequestHeader("Accept-Encoding") acceptEncoding: String) =
