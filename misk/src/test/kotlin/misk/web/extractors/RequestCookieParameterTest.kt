...
internal class RequestCookieParameterTest {
  ...
  @Test
  fun happyPath() {
    assertThat(get("/echo-app-token", listOf("app_token" to "AppToken1"))).isEqualTo("your app token is 'AppToken1'")
    assertThat(get("/echo-app-token", listOf())).isEqualTo("Required request cookie app_token not present")
  }

  @Test
  fun duplicateCookieShouldError() {
    assertThat(get("/echo-app-token", listOf("app_token" to "AppToken1", "app_token" to "AppToken2")))
  ...
  fun optionalParameter() {
    ...
    assertThat(get("/echo-optional-app-token", listOf())).isEqualTo("your app token is '<absent>'")
  }
  ...
  fun nullableParameter() {
    assertThat(get("/echo-nullable-app-token", listOf("app_token" to "AppToken1")))
      .isEqualTo("your app token is 'AppToken1'")
    assertThat(get("/echo-nullable-app-token", listOf())).isEqualTo("your app token is 'null'")
  }

  @Test
  fun nullableOptionalParameter() {
    assertThat(get("/echo-nullable-optional-app-token", listOf("app_token" to "AppToken1")))
      .isEqualTo("your app token is 'AppToken1'")
    assertThat(get("/echo-nullable-optional-app-token", listOf())).isEqualTo("your app token is '<absent>'")
  }

  @Test
  fun typeConvertedParameter() {
    assertThat(get("/echo-app-platform-type", listOf("app_platform" to "ANDROID")))
      .isEqualTo("your app platform is ANDROID")
    assertThat(get("/echo-app-platform-type", listOf())).isEqualTo("Required request cookie app_platform not present")
  }

  @Test
  fun cookieParameterType() {
    assertThat(get("/echo-app-token-as-cookie", listOf("app_token" to "AppToken1")))
      .isEqualTo("your app token is 'AppToken1'")
    assertThat(get("/echo-app-token-as-cookie", listOf())).isEqualTo("Required request cookie app_token not present")
  }

  @Test
  fun multipleRequestCookies() {
    assertThat(get("/multiple-request-cookies", listOf("app_token" to "AppToken1", "app_platform" to "IOS")))
      .isEqualTo("your app token is 'AppToken1' and your app platform is 'IOS'")
  }

  class EchoAppTokenAction @Inject constructor() : WebAction {
    @Get("/echo-app-token") fun call(@RequestCookie("app_token") appToken: String) = "your app token is '$appToken'"
  }

  class EchoOptionalAppTokenAction @Inject constructor() : WebAction {
    @Get("/echo-optional-app-token")
    fun call(@RequestCookie("app_token") appToken: String = "<absent>") = "your app token is '$appToken'"
  }

  class EchoNullableAppTokenAction @Inject constructor() : WebAction {
    @Get("/echo-nullable-app-token")
    fun call(@RequestCookie("app_token") appToken: String?) = "your app token is '$appToken'"
  }
  ...
  class EchoAppTokenTypeAction @Inject constructor() : WebAction {
    ...
    fun call(@RequestCookie("app_platform") appPlatform: AppPlatform) = "your app platform is $appPlatform"
  }

  class EchoAppTokenAsCookieAction @Inject constructor() : WebAction {
    @Get("/echo-app-token-as-cookie")
    fun call(@RequestCookie("app_token") appTokenCookie: Cookie) = "your app token is '${appTokenCookie.value}'"
  }

  class MultipleRequestCookiesAction @Inject constructor() : WebAction {
    @Get("/multiple-request-cookies")
    fun call(@RequestCookie("app_token") appToken: String, @RequestCookie("app_platform") appPlatform: String) =
