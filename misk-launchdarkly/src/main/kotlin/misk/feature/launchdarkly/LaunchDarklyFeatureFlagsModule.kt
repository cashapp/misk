...
class LaunchDarklyModule(
  ...
  override fun configure() {
    ...
    bind(misk.feature.DynamicConfig::class.toKey(qualifier)).toProvider(
      Provider<misk.feature.DynamicConfig> { LaunchDarklyDynamicConfig(featureFlagsProvider.get()) })
