...
fun <RECORD : Record?> ResultQuery<RECORD>.fetchOneOrNull(): RECORD? = this.fetchOptional().orElse(null)
...
fun <ANY> ANY?.getOrThrow(): ANY = this ?: throw IllegalStateException("Expecting value to not be null")
