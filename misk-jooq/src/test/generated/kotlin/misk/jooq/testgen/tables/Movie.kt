...
open class Movie(
  ...
  val ID: TableField<MovieRecord, Long?> =
    createField(DSL.name("id"), SQLDataType.BIGINT.nullable(false).identity(true), this, "")

  /** The column <code>jooq.movie.name</code>. */
  val NAME: TableField<MovieRecord, String?> =
    createField(DSL.name("name"), SQLDataType.VARCHAR(191).nullable(false), this, "")

  /** The column <code>jooq.movie.genre</code>. */
  val GENRE: TableField<MovieRecord, String?> =
    createField(DSL.name("genre"), SQLDataType.VARCHAR(191).nullable(false), this, "")

  /** The column <code>jooq.movie.version</code>. */
  val VERSION: TableField<MovieRecord, Int?> =
    createField(DSL.name("version"), SQLDataType.INTEGER.nullable(false), this, "")

  /** The column <code>jooq.movie.created_at</code>. */
  val CREATED_AT: TableField<MovieRecord, LocalDateTime?> =
    createField(
      DSL.name("created_at"),
      SQLDataType.LOCALDATETIME(3)
        .nullable(false)
        .defaultValue(DSL.field(DSL.raw("CURRENT_TIMESTAMP(3)"), SQLDataType.LOCALDATETIME)),
      this,
      "",
    )

  /** The column <code>jooq.movie.updated_at</code>. */
  val UPDATED_AT: TableField<MovieRecord, LocalDateTime?> =
    createField(
      DSL.name("updated_at"),
      SQLDataType.LOCALDATETIME(3)
        .nullable(false)
  ...
  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg binds: Any?): Movie =
    where(DSL.condition(condition, *binds))

  /** Create an inline derived table from this table */
  @PlainSQL
  override fun where(@Stringly.SQL condition: String, vararg parts: QueryPart): Movie =
