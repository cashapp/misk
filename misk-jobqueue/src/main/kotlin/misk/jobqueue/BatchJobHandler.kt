...
/**
 * A [BatchJobHandler] is an application implemented interface that handles jobs received by this
 * service. [BatchJobHandler]s must explicitly call [Job.acknowledge] after successful processing to
